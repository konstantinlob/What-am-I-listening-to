import { computed, defineComponent, inject, provide, h, Suspense, Transition, reactive, getCurrentInstance, resolveComponent, watchEffect, ref, markRaw, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, unref, mergeProps } from 'vue';
...
const routes = [
  {
    name: "index",
    path: "/",
    file: "/home/playerg9/git/roriwa/Spotispy/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./_nuxt/index.1d3cabb5.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.35799659.mjs'));
    const nuxtApp = useNuxtApp();
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "bg-spotify-black h-screen w-screen" }, _attrs))}>`);
