...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.7580f2a4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.ac16cd4d.mjs'));
...
//# sourceMappingURL=error-component.35799659.mjs.map
